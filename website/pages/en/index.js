  ...
  render() {
    ...
    const ProjectTitle = () => (
      <div className="container">
        ...
        <div className="row">
          <div className="col-sm"><a class="btn btn-primary" href="https://anchor.fm/docdeveloper target="_blank"><i class="fas fa-headphones"></i>Anchor.fm</a></div>
          <div className="col-sm"><a class="btn btn-success" href="https://open.spotify.com/show/2jhQ1Z1nAOY686RVok7O9I" target="_blank"><i class="fab fa-spotify"></i>Spotify</a></div>
        </div>
      </div>
    );
